...
public class Husky2 extends Critter
{
    ...
    private static Critter.Attack adjustable;
    ...
    @Override
    public Critter.Attack fight(String o)
    {
        calculateAttack(o);
        return adjustable;
    }
    ...
    public void calculateAttack(String o)
    {
        if(goal == HUNT)
        {
                    ...
                    || (o.equals("v")) ||(o.equals("<")))
            {
                ...
                {
                    adjustable = Critter.Attack.POUNCE;
                }
                else
                {
                    adjustable = Critter.Attack.SCRATCH;
                }
            }
        ...
        else if(goal > HUNT)
        {
            ...
            {
                if(previous.get(i).equals(Critter.Attack.POUNCE))
                {
                    pounce++;
                }
                if(previous.get(i).equals(Critter.Attack.ROAR))
                {
                    roar++;
                }
                else if(previous.get(i).equals(Critter.Attack.SCRATCH))
                {
                    scratch++;
                }
            }
            ...
            {
                adjustable = Critter.Attack.ROAR;
            }
            else 
            {
                adjustable = randomAttack();
    ...
    public Critter.Direction calculateMove()
    {
        x = getX();
        y = getY();
        // mate goal
        ...
        {
            adjacentObjects[_EAST] = getNeighbor(Critter.Direction.EAST);
            adjacentObjects[_SOUTH] = getNeighbor(Critter.Direction.SOUTH);
            adjacentObjects[_WEST] = getNeighbor(Critter.Direction.WEST);
            adjacentObjects[_NORTH] = getNeighbor(Critter.Direction.NORTH);
    ...
    public void learnWin()
    {
        ...
        else
        {
            ...
            else if(adjustable.equals(Critter.Attack.SCRATCH))
            {
                previous.add(Critter.Attack.POUNCE);
            }
        }
    }
    ...
    public void learnLose()
    {
        if(previous.size() > 7)
        {
            if(adjustable.equals(Critter.Attack.POUNCE))
            {
                previous.add(Critter.Attack.SCRATCH);
                previous.remove(0);
            }
            else if(adjustable.equals(Critter.Attack.ROAR))
            {
                previous.add(Critter.Attack.POUNCE);
                previous.remove(0);
            }
