...
import CritterPackage.Critter.Direction;
...
public class MiniMain {
	...
	public static void test1() 
		...
		for (int i = 1; i <= 10; i++) 
                {
			Critter.Direction move = animal2.getMove();
			System.out.print(move + " " + animal2.toString() + " ");
		}
		System.out.println();
		System.out.println();
...
*/
		...
		System.out.println();
                ...
                moves(h1,10);
                System.out.println();
                System.out.print(h1.getX() + " " + h1.getY());
                System.out.println();
	...
	// way the animal wanted to move each time.
        // Modified for specific Bird Testing
	public static void moves(Critter critter, int times) 
		...
		for (int i = 1; i <= times; i++) 
			...
			System.out.print(move + " " + critter.toString() + " ");
		}
        ...
        // Moves the given animal the given number of times and prints which
	// way the animal wanted to move each time.
        // Original moves function
	public static void moves1(Critter critter, int times) 
        {
		System.out.print(critter.getClass().getName() + " moving " + times + " times: ");
		System.out.print(critter.toString() + " ");
		for (int i = 1; i <= times; i++) 
